...
describe('GET /artists/:uuid', () => {
  ...
  it('should return the correct artist when a valid UUID is provided', async () => {
    const validArtistUuid = insertedArtist[0].uuid; // Use the correct UUID
    ...
    expect(response.body).toEqual({
      ...
      // Add other expected properties of the artist here
    });
  });

  it('should return a 404 status when an non-existing artist is provided', async () => {
  ...
  it('should return a 401 status when invalid uuid is provided', async () => {
